...
/// Holding that captures mangrove propagules or saplings staged within a plot.
class MangrovePlotHolding extends HoldingRecord {
  factory MangrovePlotHolding({
    required String id,
  ...
  Map<String, dynamic> toJson() {
    ...
    if (averageHeightCm != null) {
      json['averageHeightCm'] = averageHeightCm;
    }
    if (survivalPercent != null) {
      json['survivalPercent'] = survivalPercent;
    }
    if (plantedAt != null) {
  ...
  factory MangrovePlotHolding.fromJson(Map<String, dynamic> json) {
    ...
    return MangrovePlotHolding(
      ...
      averageHeightCm: safeDouble(json['averageHeightCm']),
      survivalPercent: safeDouble(json['survivalPercent']),
