...
/// Loading / error / empty placeholder views shared by the inventory table.
class _InventoryEventsLoading extends StatelessWidget {
  const _InventoryEventsLoading({required this.status, required this.progress});
...
class _InventoryEventsError extends StatelessWidget {
  const _InventoryEventsError({required this.error, required this.onRetry});
...
class _InventoryEventsEmpty extends StatelessWidget {
  const _InventoryEventsEmpty({required this.title, required this.icon});
