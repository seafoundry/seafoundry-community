...
class _GeneticsEventsLoading extends StatelessWidget {
  const _GeneticsEventsLoading({required this.status, required this.progress});
...
class _GeneticsEventsError extends StatelessWidget {
  const _GeneticsEventsError({required this.error, required this.onRetry});
...
class _GeneticsEventsNoData extends StatelessWidget {
  const _GeneticsEventsNoData();
