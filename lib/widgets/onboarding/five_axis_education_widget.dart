    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          // Introduction
          Text(
            'SeaFoundry tracks organisms across 5 dimensions. Two axes do not ever change (Taxonomy, Provenance), and three will change over the course of your ownership (Life Stage, Physical Form, Size). Liquid forms (gametes, embryos, larvae) use size for density and do not contribute to outplant tissue/volume totals.',
          ...
          _buildAxisCard(
            ...
            icon: Icons.timeline,
            color: Colors.purple,
            title: '3. Life Stage (will change over the course of your ownership)',
          ...
          _buildAxisCard(
            ...
            color: Colors.orange,
            title: '4. Physical Form (will change over the course of your ownership)',
          ...
          _buildAxisCard(
            ...
            color: Colors.teal,
            title: '5. Size + Quantity (will change over the course of your ownership)',
