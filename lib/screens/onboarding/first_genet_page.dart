...
import 'package:seafoundry_community/services/life_stage_constraint_service.dart';
import 'package:seafoundry_community/widgets/common/pid_status_chip.dart';
import 'package:seafoundry_community/widgets/inputs/provenance_autocomplete_field.dart';
import 'package:seafoundry_community/widgets/forms/onboarding_species_selector.dart';
...
class FirstGenetPage extends StatelessWidget {
  ...
  /// The provenance types available for onboarding (full canonical set)
  static const _onboardingProvenanceTypes = [
    ProvenanceType.wild,
    ProvenanceType.cohort,
