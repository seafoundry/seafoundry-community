...
import 'package:seafoundry_community/cubits/auth_form_cubit.dart';
import 'package:seafoundry_community/services/logging_service.dart';
import 'package:seafoundry_community/theme/theme.dart';
import 'package:seafoundry_community/widgets/auth/promo_carousel.dart';
...
class _CommunityAuthScreenState extends State<CommunityAuthScreen> {
  ...
  Widget _buildHeader(AuthFormState formState) {
    return Column(
      children: [
        Image.asset(
          'assets/seafoundry_community_logo.png',
          height: 128,
  ...
  Widget _buildPasswordField(
    ...
    return TextFormField(
      ...
      onFieldSubmitted: (_) => _handleSubmit(context, formState),
      decoration: InputDecoration(
        labelText: 'Password',
