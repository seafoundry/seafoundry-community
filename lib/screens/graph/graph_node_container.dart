...
class GraphNodeContainer extends StatelessWidget {
  final GraphNode node;

  const GraphNodeContainer({super.key, required this.node});
  ...
  Widget _buildBody(BuildContext context, GraphNodeState nodeState) {
    ...
    switch (node.modelType) {
      ...
      case ModelType.group:
        return const Center(child: Text('Group details - coming soon'));
      case ModelType.organismRecord:
