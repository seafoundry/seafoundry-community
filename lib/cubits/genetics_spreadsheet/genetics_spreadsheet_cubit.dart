...
import 'package:seafoundry_community/models/schemas/provenance_schema.dart';
...
import 'package:seafoundry_community/services/spreadsheet/genetics_data_loader.dart';
import 'package:seafoundry_community/services/spreadsheet/genetics_filter_service.dart';
...
class GeneticsSpreadsheetCubit extends Cubit<GeneticsSpreadsheetState>
  ...
  static const Map<String, dynamic> exampleRow = {
    ...
    'collecting_institution': 'Example Institution',
    'latitude': '25.12345',
    'longitude': '-80.54321',
