...
import 'package:seafoundry_community/models/mixins/life_stage_progression_mixin.dart';
import 'package:seafoundry_community/models/mixins/measurable_mixin.dart';
import 'package:seafoundry_community/models/types/inventory_event_type.dart';
...
class OrganismMergeBloc
  ...
  Future<OrganismRecord?> createRecord() async {
    ...
    // Pre-mint id and slug OUTSIDE the transaction (each opens its own txn).
    // Never mint a slug inside an outer runTransaction closure.
