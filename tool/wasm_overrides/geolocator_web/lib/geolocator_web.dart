...
import 'src/html_geolocation_manager_stub.dart'
    if (dart.library.html) 'src/html_geolocation_manager.dart';
import 'src/html_permissions_manager_stub.dart'
    if (dart.library.html) 'src/html_permissions_manager.dart';
