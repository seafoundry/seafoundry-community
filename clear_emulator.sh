...
FIRESTORE_PORT="${FIREBASE_FIRESTORE_EMULATOR_PORT:-58080}"
curl -X DELETE "http://localhost:${FIRESTORE_PORT}/emulator/v1/projects/${PROJECT_ID}/databases/(default)/documents" 2>&1 | head -5
